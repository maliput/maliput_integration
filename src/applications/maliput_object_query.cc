...
///Backend, BoundingRegionType (BoundingBox as default), Vector3 Properties(Position, size, Vector3 orientation(roll, pitch, yaw)), Oveerlapping Type (Intersected, Disjointed, Contained)
